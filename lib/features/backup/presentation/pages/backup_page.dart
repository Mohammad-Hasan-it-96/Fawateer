        ...
        _card(
          child: Column(
            children: [
              ...
              // After a reinstall the local record is gone but the device id
              // isn't, so the server can still say which account to pick.
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          l10n.backupAccountHint(state.accountHint!),
                          style: TextStyle(
                              fontSize: 12,
